...
features:
    ...
    - icon: fas fa-gamepad
      ...
      url: https://github.com/inesfmarques/minigames/tree/master/huehue
    - icon: fas fa-language
      header: inesfmarques/langrec
      text: Uma ferramenta que usa aprendizagem automática para reconhecer a língua em que uma frase foi escrita
      url: https://github.com/inesfmarques/langrec
    - icon: fab fa-dyalog
      header: Dyalog/dyalog-jupyter-notebooks
      text: Escrevi alguns notebooks Juypter para introduzir alguns conceitos em APL
      url: https://github.com/Dyalog/dyalog-jupyter-notebooks

    - icon: fas fa-bug
      header: Pequenas correções no código
