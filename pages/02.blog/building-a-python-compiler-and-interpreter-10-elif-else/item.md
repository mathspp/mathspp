In the 10th part of [this series][series-link] of building a Python compiler and interpreter we will add support for the statements `elif` and `else`.

===


# Building a Python compiler and interpreter – 10 elif else
