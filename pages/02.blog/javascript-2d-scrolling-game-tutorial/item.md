...
If you want the full source code for your game, remember that the structure for your HTML page should look like this:
...
Then, inside the `<script>` tags, you should have all of your JavaScript code, included below:
