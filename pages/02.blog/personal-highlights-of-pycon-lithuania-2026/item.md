...
![A picture of a large rectangular cake with the PyCon Lithuania logo in the middle.](_cake.webp "The PyCon Lithuania cake.")
...
![A slanted picture of a blue screen showing the player RGS at the top of the quiz podium.](_quiz.webp "The final score for the quiz.")
...
![A Rubik's cube that has been rigged and is impossible to solve.](_rubiks.webp "Rigged Rubik's cube.")
...
![A small card with some stamps on white egg-shaped regions.](_egg_hunt.webp "My card filled with stamps.")
...
![The back of a t-shirt showing two entangled snakes with the words “Python Whisperer” at the bottom.](_python_whisperer.webp "The Python Whisperer t-shirt.")
...
![Side shot of Rodrigo giving a lightning talk.](_what_the_python.webp "Rodrigo making the audience go “What the Python?”")
...
![Aidis Stukas and Rodrigo Girão Serrão at PyCon Lithuania presenting the package pycon-lithuania.](_aidis.webp "Rodrigo typing while Aidis presents.")
